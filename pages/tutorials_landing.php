...
?>
    ...
    <main role="main" class="container">
        ...
        <img class="land-image" style="display: inline-flex;" src="../assets/media/tutorials2.PNG" alt="Img" title="About Unix" width=300px height="auto"/>
        ...
        <img class="land-image" style="display: inline-flex; float: right;" src="../assets/media/tutorial_thumb.png" alt="Img" title="About Unix" width=300px height="auto"/>
    </main><!-- /.container -->
