...
<main role="main" class="container">
    ...
    <div class="starter-template">
        ...
        <h3>Quick links</h3>
        <a href="pages/about_landing.php"><img class="land-image" src="assets/media/history_thumb.png" alt="About" width="50%" height="auto"/></a>
        <p>About</p>
        <a href="pages/tutorials_landing.php"><img class="land-image" src="assets/media/tutorial_thumb.png" alt="Tutorials" width="50%" height="auto"/></a>
        <p>Tutorials</p>
        <a href="pages/quizzes_landing.php"><img class="land-image" src="assets/media/quiz_thumb.png" alt="Quizzes" width="50%" height="auto"/></a>
        <p>Quizzes</p>
        <a href="pages/references_landing.php"><img class="land-image" src="assets/media/ref_thumb.png" alt="References" width="50%" height="auto"/></a>
        <p>References</p>
    </div>
</main><!-- /.container -->
