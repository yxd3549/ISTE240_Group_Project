...
<main role="main" class="container">
    <div class="starter-template">
        ...
        <a href="pages/about_landing.php">
            <img class="land-image" src="assets/media/history_thumb.png" alt="About" title="About Unix" width=400px height="auto"/>
        </a>
        <!--<span>About</span> -->

        <a href="pages/tutorials_landing.php">
            <img class="land-image" src="assets/media/tutorial_thumb.png" alt="Tutorials" title="Tutorials" width="400px" height="auto"/>
        </a>
        <!--<p>Tutorials</p>-->

        <a href="pages/quizzes_landing.php">
            <img class="land-image" src="assets/media/quiz_thumb.png" alt="Quizzes" title="Quizzes" width="400px" height="auto"/>
        </a>
        <!--<p>Quizzes</p>-->
